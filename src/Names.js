export const masterListBrothers = {
  ...
  evgeniy_voldizhev: {
    ...
    russianName: "Евгений Болдыжев",
  },
  sergei_frolov: {
    assignments: ["reading", "householder"],
    russianName: "Сергей Фролов",
  },
  andrei_frolov: {
    assignments: ["reading", "householder"],
...
export const masterListSisters = {
  ...
  natalya_konovalova: {
    assignments: ["initial", "householder", "return", "bibleStudy"],
    russianName: "Наташа Коновалова",
  },
  mavis_springer: {
    assignments: ["initial", "householder", "return", "bibleStudy"],
    russianName: "Мэвис Спрингер",
  },
  katya_pichugina: {
  ...
  brenda_augustine: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Бренда Августин",
  },
  monica_kugman: {
    assignments: ["initial", "householder", "return"],
    russianName: "Моника Кугман",
  },
  lida_smik: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
  ...
  larisa_dvornik: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Лариса Дворник",
  },
  irina_timchuk: {
    assignments: ["return", "householder", "initial", "bibleStudy"],
    russianName: "Ира Тимчук",
  },
  sveta_ambartsumyan: {
    assignments: ["return", "householder", "initial", "bibleStudy"],
    russianName: "Света Амбарцумян",
  },
  natalya_vidulina: {
    assignments: ["return", "householder", "initial", "bibleStudy"],
  ...
  kristina_rechkalova: {
    assignments: ["initial", "return", "householder"],
    russianName: "кристина речкалова",
  },
  khidoyat_asimova: {
    assignments: ["initial", "householder"],
    russianName: "хидоят асимова",
  },
  farzona_asimova: {
    assignments: ["initial", "householder"],
  ...
  anastasia_voldizheva: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Анастасия Болдыжева",
  },
  svetlana_molostova: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Светлана Молостова",
  },
  maya_doguzova: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Мая Догузова",
  },
  olga_frolova: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
  ...
  alena_predel: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Алена Предель",
  },
  anastasia_nikitina: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Анастасия Никитина",
  },
  leila_budanova: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Лейла Буданова",
  },
  larisa_predel: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Лариса Предель",
  },
  maria_predel: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
    russianName: "Мария Предель",
  },
  aisha_novikova: {
    assignments: ["initial", "return", "householder", "bibleStudy"],
  ...
  zhanna_abilova: {
    assignments: ["householder"],
    russianName: "Жана Абилова",
  },
  taya_stolpovskaya: {
    assignments: ["householder"],
    russianName: "Тая Столповская",
  },
  tatyana_verzhbo: {
    assignments: ["householder"],
  ...
  const randomNoRepeats = (array) => {
    ...
    return function test() {
      ...
      if (arrayNames.length > 0) {
        el = masterListBrothers[item].assignments.some(
          (a) => assign.includes(a) || "householder".includes(a)
        );
      } else {
        el = masterListBrothers[item].assignments.some((a) =>
          assign.includes(a)
        );
      }
      if (assignment && !el) {
...
export const chooseSister = (assign, householder) => {
  ...
  const randomNoRepeats = (array) => {
    ...
    return function test() {
      ...
      let el;
      if (arrayNames.length > 0) {
        el = masterListSisters[item].assignments.some(
          (a) => assign.includes(a) || "householder".includes(a)
        );
      } else {
        el = masterListSisters[item].assignments.some((a) =>
          assign.includes(a)
        );
      }
      if (assignment && !el) {
